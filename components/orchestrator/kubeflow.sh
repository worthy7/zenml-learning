...
yes | zenml orchestrator destroy comp_test_kubeflow -p k3d 
...
zenml orchestrator deploy comp_test_kubeflow --flavor=kubeflow -p k3d -r local ### TODO may need to tell kubeflow more config
